    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct DataTypes.MakerInfo",
        "components": [
          {
            "name": "stakedAmount",
            "type": "uint256",
